...
<hr>
<h1 align="center"> 📎 Documentação - 2º Sprint </h1>
<br>
<p align = "center">
...
<a id="objetivo"></a>
Entregar as bases avaliativas e melhorias visuais da aplicação, garantindo:

- Desenvolvimento inicial do sistema de avaliação
- Refatoração do codigo para adequação ao micro framework Flask e integração de Javascript
...
| ---- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ------ |
| 1    | Alta       | Como contratante, quero que meus funcionários compreendam as principais habilidades (skills) importantes na área de TI, para que se preparem em seus trabalhos e desenvolvam as competências necessárias para a aplicação do método Scrum.                                                              | 40      | 1      |
| 2    | Baixa      | Como contratante, quero ter um sistema de avaliação para que meus funcionários sejam testados em conhecimentos sobre o método Scrum.                             | 20      | 1      |
| 3    | Baixa      | Como contratante, quero ter acesso a documentação de desenvolvimento para acompanhar os processos adotados. | 20      | 1      |
